...
public class NGram_Type extends BaseType_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.mpiergal.hw1.NGram");
  ...
  public int getTokenArray(int addr) {
      ...
      jcas.throwFeatMissing("tokenArray", "edu.cmu.lti.mpiergal.hw1.NGram");
  ...
  /** @generated */
  final Feature casFeat_nGramLength;
  /** @generated */
  final int     casFeatCode_nGramLength;
  /** @generated */ 
  public int getNGramLength(int addr) {
        if (featOkTst && casFeat_nGramLength == null)
      jcas.throwFeatMissing("nGramLength", "edu.cmu.lti.mpiergal.hw1.NGram");
    return ll_cas.ll_getIntValue(addr, casFeatCode_nGramLength);
  }
  /** @generated */    
  public void setNGramLength(int addr, int v) {
        if (featOkTst && casFeat_nGramLength == null)
      jcas.throwFeatMissing("nGramLength", "edu.cmu.lti.mpiergal.hw1.NGram");
    ll_cas.ll_setIntValue(addr, casFeatCode_nGramLength, v);}
  ...
  public NGram_Type(JCas jcas, Type casType) {
    ...
    casFeat_nGramLength = jcas.getRequiredFeatureDE(casType, "nGramLength", "uima.cas.Integer", featOkTst);
    casFeatCode_nGramLength  = (null == casFeat_nGramLength) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_nGramLength).getCode();

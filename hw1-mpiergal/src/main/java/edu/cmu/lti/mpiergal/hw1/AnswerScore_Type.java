...
public class AnswerScore_Type extends BaseType_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.mpiergal.hw1.AnswerScore");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "edu.cmu.lti.mpiergal.hw1.AnswerScore");
